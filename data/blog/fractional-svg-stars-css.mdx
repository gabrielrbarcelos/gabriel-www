...
You can find the full source code [here](https://github.com/gabrielbarcelos/gabrielbarcelos-site/blob/master/components/blog/rating.tsx). Let me know if you found this CSS tip useful by pressing the heart below 👇